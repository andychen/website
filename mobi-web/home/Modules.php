...
class Modules {
  ...
  public static $module_data = Array(
    ...
    'download' => Array(
      'title' => 'Download',
      'extra' => TRUE,
      'restricted' => Array('android', 'blackberry', 'iphone'),
      ),
    );
  ...
  public static function init($branch, $certs, $platform=NULL) {
	...
	if ((!isset($data['restricted']) || in_array($platform, $data['restricted']))
	    && (!isset($data['certs_required']) || $certs)
	    && (!isset($data['extra']) || ($branch !== 'Basic'))) {
  ...
  public static function is_right_platform($platform, $module) {
    ...
    return (!isset($data['restricted']) || in_array($platform, $data['restricted']));
  }
  ...
  public static function subtitle($module) {
    if (isset(self::$module_data[$module]['subtitle'])) {
  ...
  public static function url($module, $certs=FALSE) {
    ...
    if (isset(self::$module_data[$module]['certs_required'])
        && self::$module_data[$module]['certs_required']) {
      if (!$certs) {
	$url = "";
