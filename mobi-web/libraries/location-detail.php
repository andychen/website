...
// search 3 months before and 3 months after
$search_range = new TimeRange(increment_month($today, -3), increment_month($today,3));
...
if (!$term_today && $terms_after_today) {
  $term_today = array_shift($terms_after_today);
}
